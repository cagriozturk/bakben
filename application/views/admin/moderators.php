...
<div class="col-md-5">
 ...
 <div class="btn-group ga1">
   <a href="<?php echo base_url();?>admin/create_user/moderator" class="btn btn-default dropdown-toggle ga-btn">
  Modaratör Ekle
  </a>
 </div>
			  ...
			  <thead>
				...
				?>
					...
					<tr>
						...
						<td>
							 <a href="<?php echo base_url();?>admin/edit_user/<?php echo $r->id;?>/moderator"><div class="btn bg-primary wnm-user">Değiştir</div></a>
	 
							 <?php if($r->active==1) { ?>
							 
								<a href="<?php echo base_url();?>admin/blockUser/<?php echo $r->id;?>/moderator" onclick="return confirm('Kullanıcıyı Engellemek İstiyormusunuz?')"><div class="btn bg-primary wnm-user">Engelle</div></a>
							 
							 <?php } else {?>
							 
								<a href="<?php echo base_url();?>admin/activateUser/<?php echo $r->id;?>/moderator" onclick="return confirm('Kullanıcıyı etkinleştirmek istiyormusunuz?')"><div class="btn bg-primary wnm-user">Etkinleştir</div></a>
							 
							 <?php } ?>
							 
							<a href="<?php echo base_url();?>admin/deleteUser/<?php echo $r->id;?>/moderator"><div class="btn bg-primary wnm-user" onclick="return confirm('Kullanıcıyı silmek istiyormusunuz?')">Sil</div></a> 
