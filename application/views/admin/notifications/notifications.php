   ...
   <div class="col-md-5">
      <div class="ga">
         <div class="btn-group ga1">
            <a href="<?php echo base_url();?>admin/addeditNotifications" class="btn btn-default dropdown-toggle ga-btn">
            Bildirim Ekle
            </a>
         </div>
      </div>
      ...
      <table id="example" class="cell-border" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><?php echo date('d-m-Y',strtotime($r->last_date)); ?></td>
               <td><?php echo $r->status; ?></td>
               <td>
                  <a href="<?php echo base_url();?>admin/addeditNotifications/<?php echo $r->nid;?>/<?php echo $r->title;?>" class="btn bg-primary wnm-user"> <i class="fa fa-edit"></i> Değiştir</a>
                  <a href="<?php echo base_url();?>admin/notifications/<?php echo $r->nid;?>" onclick="return confirm('Bu kaydı silmek istediğinize emin misiniz?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Sil</a>
               </td>
            </tr>
            <?php 
			} 
