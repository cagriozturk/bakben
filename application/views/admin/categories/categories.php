   ...
   <div class="col-md-5">
      <div class="ga">
         <div class="btn-group ga1">
            <a href="<?php echo base_url();?>admin/addeditCategories" class="btn btn-default dropdown-toggle ga-btn">
            Kategori Ekle
            </a>
         </div>
      </div>
      ...
      <table id="example" class="cell-border" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="<?php echo base_url();?>admin/addeditCategories/<?php echo $r->catid;?>/<?php echo $r->name;?>" class="btn bg-primary wnm-user"> <i class="fa fa-edit"></i> Değiştir</a>
                  <a href="<?php echo base_url();?>admin/categories/<?php echo $r->catid;?>" onclick="return confirm('Bu kaydı silmek istediğinize emin misiniz?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Sil</a>
               </td>
            </tr>
