   ...
   <div class="col-md-5">
      <div class="ga">
         <div class="btn-group ga1">
            <a href="<?php echo base_url();?>admin/addeditSubCategories" class="btn btn-default dropdown-toggle ga-btn">
            Alt Kategori Ekle
            </a>
         </div>
      </div>
      ...
      <table id="example" class="cell-border" cellspacing="0" width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="<?php echo base_url();?>admin/addeditSubCategories/<?php echo $r->subcatid;?>/<?php echo $r->name;?>" class="btn bg-primary wnm-user"> <i class="fa fa-edit"></i> Değiştir</a>
                  <a href="<?php echo base_url();?>admin/subcategories/<?php echo $r->subcatid;?>" onclick="return confirm('Are you sure you want to delete this record?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Sil</a>
               </td>
            </tr>
            <?php } 
			} 
