      ...
      <div class="col-md-9">
         ...
         <div class="col-md-12 padd">
            <form method="post" id="user_profile_form" action="<?php echo base_url();?>user/update_profile" enctype="multipart/form-data">
               ...
               <div class="details"> 
                  <strong>Ad </strong>: 
                  <input type="text" name="first_name" value="<?php echo $d->first_name;?>" placeholder="Adınızı Yazın" style="border:none;background:#fafafa !important;padding: 1px 0 !important;"/>
               </div>
               <div class="details"> 	
                  <strong>Soyad </strong>: 
                  <input type="text" name="last_name" value="<?php echo $d->last_name;?>" placeholder="Soyadınızı Yazın" style="border:none;background:#fafafa !important;padding: 1px 0 !important;"/>
               </div>
               <div class="details"> 
               ...
               <div class="details col-md-12" id="user_photo_div" style="display:none;margin-top:0;padding-left:0;">
                  ...
                  <div class="col-md-1">
                     <a id="cancel_user_change_photo" title="Resim yükleme iptal edildi." onclick="do_user_photo_div('hide')" style="cursor:pointer;">İptal</a>
                  </div>
               </div>
...
<script type="text/javascript"> 
   (function($,W,D)
   {
      ...
      JQUERY4U.UTIL =
      {
          ...
          {
              //Additional Methods			
   		$.validator.addMethod("lettersonly",function(a,b){return this.optional(b)||/^[a-z ]+$/i.test(a)},"Geçerli bir ad giriniz.");
              ...
              $("#user_profile_form").validate({
   			...
   			messages: {
   				...
   				image: {
						  ...
						  accept: "İzin verilen jpg / jpeg / png uygun resim formatları."
                      }
   			},
