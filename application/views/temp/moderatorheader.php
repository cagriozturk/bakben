...
<html lang="en">
   <head>
      ...
      <title><?php if(isset($title)) echo $title." - DOES"; else echo "Welcome To DOES Moderator Panel"; ?></title>
                     ...
                     <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                           <ul class="nav navbar-nav">
                              <li><a href="<?php echo base_url();?>moderator/profile"><i class="fa fa-user"></i> Hesap</a></li>
                              <!-- <li><a href="#"><i class="fa fa-envelope-square"></i> Message</a></li>
                                 <li><a href="#"> <i class="fa fa-cog"></i> Projects</a></li>	-->
                              <li class="dropdown">
                                 <a href="<?php echo base_url();?>auth/logout" class="dropdown-toggle" > <i class="fa fa-lock"></i> Çıkış </a>        
                              </li>
                           </ul>
                        </div>
                        <!-- /.navbar-collapse -->
