...
<li><a href="#">  Profilim </a></li>
 ...
 <div class="col-md-12 padd">
	...
	<form method="post" id="user_profile_form" action="<?php echo base_url();?>moderator/updateProfile" enctype="multipart/form-data">

		<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
	
 <div class="details"> 
	<strong>Ad </strong>: 
		<input type="text" name="first_name" value="<?php echo $d->first_name;?>" placeholder="Enter your first name" style="border:none;background:#fafafa !important;padding: 1px 0 !important;"/>
 </div>
 
 <div class="details"> 	
	<strong>Soyad </strong>: 
		<input type="text" name="last_name" value="<?php echo $d->last_name;?>" placeholder="Enter your last name" style="border:none;background:#fafafa !important;padding: 1px 0 !important;"/>
 </div>
